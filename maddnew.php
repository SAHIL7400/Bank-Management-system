...
<body style="background:#FFDD33;background-size: 100%">
...
{
  if (!$con->query("insert into useraccounts (name,aadhaar_number,accountNo,accountType,city,address,email,password,balance,source_of_income,phone,branch) values ('$_POST[name]','$_POST[aadhaar]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[phone]','$_POST[branch]')")) {
