...
<head>
  ...
  <?php $note ="";
    ...
    if (isset($_POST['withdraw']))
    {
      ...
      makeTransactionCashier('withdraw',$_POST['amount'],'0',$_POST['userId']);
      $note = "<div class='alert alert-success'> Transaction completed successfully</div>";
    ...
    if (isset($_POST['deposit']))
    {
      ...
      makeTransactionCashier('deposit',$_POST['amount'],'0',$_POST['userId']);
      $note = "<div class='alert alert-success'> Transaction completed successfully</div>";

    }
   ?>
</head>
<body style="background:#900C3F;background-size: 100%">
